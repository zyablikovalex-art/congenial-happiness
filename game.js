...
// ---- Мир ----
/* Размеры поля привязаны к росту игрока. Модель в scene.js — 85.8 мировых
   единиц от газона до макушки, это «185 см», значит 1 единица = 2.16 см.
   Дальше берём реальные пропорции: поле 120 x 90 м при росте 1.85 м даёт
   отношения 64.86 и 48.65 к росту.   85.8 x 64.86 = 5562,  85.8 x 48.65 = 4172. */
const PITCH_L = 5562;     // длина поля (ось x) — «120 м»
const PITCH_W = 4172;     // ширина/глубина (ось z) — «90 м»
