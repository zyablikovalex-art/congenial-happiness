...
window.Scene3D = (function () {
  ...
  const camCfg = { angle: 35, height: 14 };
  ...
  function makeHouses() {
    ...
    // С ближней стороны домов нет: камера стоит там же и смотрит от них,
    // так что они всегда за спиной — только геометрия впустую.
    return grp;
  }
  ...
  function makeYard() {
    ...
    const spots = [
      ...
      // с ближней стороны тоже пусто — она за камерой
    ];
